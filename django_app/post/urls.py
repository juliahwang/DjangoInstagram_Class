...
urlpatterns = [
    ...
    url(r'^youtube/search/$', views.youtube_search, name='default_youtube_search'),
    url(r'^youtube/post/create/$', views.post_create_with_video, name='post_create_with_video'),
    # url(r'^youtube/search/(?P<q>\w+)/$$', views.youtube_search_result, name='youtube_search_result'),
